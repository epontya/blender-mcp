...
> **Personal fork note:** Telemetry is disabled by default in my fork. I'm using this purely for local learning/experimentation and do not want any data collection enabled.
